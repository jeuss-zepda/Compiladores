...
public class OpcionalDialog extends JDialog {
    ...
    public OpcionalDialog(Nueva parent) {
        super(parent, "Opcional (?)", true);
    ...
    private void inicializarComponentes() {
        ...
        JButton btnAplicar = new JButton("Aplicar Opcional (?)");
        btnAplicar.addActionListener(e -> {
            String indice = lblIndiceResultado.getText();
            ventanaPrincipal.indicesExistentes.add(indice);
            JOptionPane.showMessageDialog(this, "Opcional aplicado con índice: " + indice);
            dispose();
        });
